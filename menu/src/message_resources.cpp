...
void MessageResources::fillMessagesEN() {
  ...
  GET_UI_MESSAGE(hotkeyBindings, HotkeyBindingsMessages::menuHintMouseMove_tooltip) = U"Show top-left shortcut to menu when the mouse moves (plugin config menu)";
  ...
  GET_UI_MESSAGE(hotkeyBindings, HotkeyBindingsMessages::hotkey) = U"Controller master key";
  ...
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::showOptions) = U"Pause game and open menu (plugin config menu)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::previousProfile) = U"Reconfigure renderer with previous config profile, if any (see profile settings page)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::nextProfile) = U"Reconfigure renderer with next config profile, if any (see profile settings page)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::nextSaveSlot) = U"Change the active save state slot (for quick save/load)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::quickSave) = U"Save current game state (replace save in the active slot)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::quickLoad) = U"Load the latest quick save (from the active slot)";
...
void MessageResources::fillMessagesFR() {
  ...
  GET_UI_MESSAGE(hotkeyBindings, HotkeyBindingsMessages::title) = U"Raccourcis clavier/manette";
  ...
  GET_UI_MESSAGE(hotkeyBindings, HotkeyBindingsMessages::bindingsGroup) = U"Assignation des raccourcis";
  ...
  GET_UI_MESSAGE(hotkeyActions, HotkeyActions::toggleOsd) = U"Affichage d'informations";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::showOptions) = U"Mettre le jeu en pause et ouvrir le menu (configuration du plugin)";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::previousProfile) = U"Reconfigurer le rendu avec le profil de configuration précédent, si disponible";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::nextProfile) = U"Reconfigurer le rendu avec le profil de configuration suivant, si disponible";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::nextSaveSlot) = U"Changer l'emplacement actif de sauvegarde/chargement rapide";
  GET_UI_MESSAGE(hotkeyActionsTooltips, HotkeyActions::quickSave) = U"Sauvegarder l'état courant du jeu (remplacer la sauvegarde dans l'emplacement actif)";
