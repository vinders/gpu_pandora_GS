...
void ColorTheme::updateTheme(video_api::Renderer& renderer, ColorThemeType type) {
  switch (type) {
    ...
    default: {
      ...
      SET_THEME_COLOR(renderer, 120,120,120, 1.f, disabledLabel)
      ...
      SET_THEME_COLOR(renderer, 138,174,208, 1.f, comboBoxControl)
      SET_THEME_COLOR(renderer, 233,239,244, 1.f, comboBoxDropdown)
      SET_THEME_COLOR(renderer,  67, 82, 97, 1.f, comboBoxLabel)
