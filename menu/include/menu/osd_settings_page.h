...
namespace menu {
  class OsdSettingsPage final : public Page {
  public:
    OsdSettingsPage(std::shared_ptr<RendererContext> context, std::shared_ptr<RendererStateBuffers> buffers,
    ...
    ~OsdSettingsPage() noexcept override;
