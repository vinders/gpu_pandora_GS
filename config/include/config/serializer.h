...
namespace config {
  ...
  public:
    ...
    static void writeGlobalConfigFile(const UnicodeString& configDir, const VideoConfig& videoCfg,
    ...
    ///         - bad_alloc on allocation failure
    static void readGlobalConfigFile(const UnicodeString& configDir, VideoConfig& outVideoCfg,
